...
public class UsuarioService {
	...
	private void validarCamposObrigatorios(Usuario usuario) throws CampoInvalidoException {
		...
		mensagemValidacao += validarCampoData(usuario.getDataNascimento(), "dataNascimento");
	...
	// TODO Data com ano mínimo (ano atual menos 18) e ano máximo (ano atual menos
	// 70)
	private String validarCampoData(LocalDate dataNascimento, String nomeCampo) {
		...
		if (anoAtual - anoNascimento < 18) {
			return "Não aceitamos menores de idade";
		}
